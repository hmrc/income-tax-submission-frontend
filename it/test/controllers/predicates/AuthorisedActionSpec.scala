...
import common.EnrolmentIdentifiers.individualId
...
//      ))
//
//      Enrolment(EnrolmentKeys.Individual, Seq(EnrolmentIdentifier(EnrolmentKeys.Individual, EnrolmentIdentifiers.individualId)), "Activated")
