      ...
      "initialiseJourney() is called it" should {
        "as an individual return status code 303" in {
          ...
          await(response).header.headers shouldBe Map("Location" ->
            "http://localhost:9938/mdtp/uplift?origin=update-and-submit-income-tax-return&confidenceLevel=250&completionURL=/update-and-submit-income-tax-return/iv-uplift-callback&failureURL=/update-and-submit-income-tax-return/error/we-could-not-confirm-your-details")
        }
