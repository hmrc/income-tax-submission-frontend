...
class AuthorisedAction @Inject()(
                                ...
                                (implicit val authService: AuthService,
                                 ...
                                 val mcc: MessagesControllerComponents) extends ActionBuilder[User, AnyContent] with I18nSupport with SessionDataHelper {
    ...
    withSessionId { sessionId =>
      authService.authorised().retrieve(affinityGroup) {
        ...
        case _: AuthorisationException =>
          ...
          // ToDo - Check this -> IndividualAuthErrorController
...
//                                                 sessionId: String
//                                                )(implicit request: Request[A], hc: HeaderCarrier): Future[Result] =
//    sessionDataService.getSessionData(sessionId).flatMap { UserSessionData =>
//      authService
//        .authorised(EnrolmentHelper.agentAuthPredicate(UserSessionData.mtditid))
//        .retrieve(allEnrolments)(
//          enrolments => handleForValidAgent(block, UserSessionData.mtditid, UserSessionData.nino, enrolments, isSupportingAgent = false, sessionId)
//        )
//        .recoverWith(agentRecovery(block, UserSessionData.mtditid, UserSessionData.nino, sessionId))
//    }.recover {
