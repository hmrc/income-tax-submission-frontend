...
case class TaxReturnReceivedModel(name: String,
...
object TaxReturnReceivedModel {
  implicit lazy val formats: OFormat[TaxReturnReceivedModel] = Json.format[TaxReturnReceivedModel]
}
