...
class StartPageViewSpec extends AnyWordSpec with Matchers with GuiceOneAppPerSuite with ViewTest{
  ...
  val bullet3DonationsToCharityAgent = "your donations to charity"
  ...
  val viewEmploymentInformationAgent = "You can view your employment information but cannot use this service to update it until 6 April 2022."
